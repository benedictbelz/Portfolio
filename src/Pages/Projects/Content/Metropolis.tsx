        ...
        return (
            <div className='wrapper'>
                ...
                <div className='category text'>
                    <p>
                        This project was an exploration of the early silent movie »Metropolis« by Fritz Lang. His visionary picture was a groundbreaking step
                        for the Sience Fiction genre in terms of visualization and story telling. I grabbed some essential parts of his movie and mixed it with
                        modern elements of »Blade Runner«, an other visionary masterpiece.
                    </p>
                </div>
                <div className='category video'>
                    <video
                        src='assets/projects/metropolis/metropolis.mp4'
                        preload='metadata'
                        poster='assets/projects/metropolis/metropolis_05.jpg'
                        controls
